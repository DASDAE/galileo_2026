...
## Bonus (time permitting) {.smaller}

:::{.tight}
:::{.incremental}
1. **The Need for Speed**: A demonstration of using [JAX](https://github.com/jax-ml/jax) to speed up DASCore.

2. **Novel or Nonsense**: Evaluating research created by ChatGPT Sol and Claude Fable 5.
:::
:::
